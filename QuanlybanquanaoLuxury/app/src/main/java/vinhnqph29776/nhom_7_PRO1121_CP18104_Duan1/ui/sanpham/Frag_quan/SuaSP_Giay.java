...
public class SuaSP_Giay extends AppCompatActivity {
...
DAO_giay dao;
   ...
   MaterialButton btn_add;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dao=new DAO_giay(getApplicationContext());
//        add_uri.setVisibility(View.INVISIBLE);
        init1();
//        bundle.getString("tensp")
        Bundle bundle = getIntent().getExtras();
        add_tensp.setText(bundle.getString("tensp_g"));
        add_kcsp.setText(bundle.getString("size_g"));
        add_giatien.setText(bundle.getString("gia_g"));
        add_soluong.setText(bundle.getString("sl"));
...
btn_add.setText("Sửa Sản Phẩm");
 ...
 dao=new DAO_giay(getApplicationContext());
                ...
                if(dao.update_giay(sanPham1,msp)>0){
