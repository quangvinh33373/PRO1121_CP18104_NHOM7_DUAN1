...
public class DBHelper_quan extends SQLiteOpenHelper {
    public DBHelper_quan(@Nullable Context context) {
        super(context,"quan_02", null, 2);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        String sanPham1 = "CREATE TABLE sp_quan(MaSP INTEGER PRIMARY KEY AUTOINCREMENT," +
                " TenSp TEXT Not Null," +
                "Size TEXT not null," +
                "Gia Text Not null," +
...
//        db.execSQL(hoaDon);
    ...
    public void onUpgrade(SQLiteDatabase db, int i, int i1) {
                db.execSQL("DROP TABLE IF EXISTS sp_quan");
